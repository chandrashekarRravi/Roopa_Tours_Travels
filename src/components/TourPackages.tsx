...
const packages = [
  {
    id: 1,
    title: "Coastal Karnataka Heritage",
    duration: "4 Days / 3 Nights",
    location: "Mangalore - Udupi - Murdeshwar",
  ...
  {
    id: 2,
    title: "Ruins of Vijayanagara",
    duration: "3 Days / 2 Nights",
    location: "Hampi - Badami",
  ...
  {
    id: 3,
    title: "Western Ghats Escape",
    duration: "5 Days / 4 Nights",
    location: "Coorg - Chikmagalur",
    image: "/images/gokarna_beach.png", // reusing an image for demonstration
    rating: 4.8,
    reviews: 215,
  },
];
