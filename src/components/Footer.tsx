      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-6 mb-12">
          <div className="md:col-span-2">
            <div className="font-playfair text-2xl font-bold tracking-tight text-white mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-zinc-400 text-sm">
              ...
              <li><a href="#cabs" className="hover:text-orange-400 transition-colors">Cab Services</a></li>
