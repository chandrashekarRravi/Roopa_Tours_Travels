...
export default function WorkingProcess() {
  ...
  return (
    <section ref={containerRef} className="relative w-full bg-[#0E14CC] min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 w-full pt-32 pb-32">
        <h2 className="text-center font-playfair text-5xl md:text-7xl font-bold text-[#FFFFFF] mb-32 drop-shadow-2xl">
          How Roopa Works
        </h2>
              ...
              >
                ...
                <div className="md:hidden flex justify-center w-full relative z-30 mb-4 order-first">
                  <div className="relative w-[120px] h-[120px] flex items-center justify-center">
                    <motion.div
                      style={{ rotate }}
                      className="absolute inset-0 rounded-full border-2 border-[#FFFFFF]/40 border-t-white border-l-transparent"
                    />
                    <div className="w-[60px] h-[60px] rounded-full bg-[#EAFFBF] flex items-center justify-center text-white font-bold text-xl shadow-[0_0_30px_rgba(233,79,55,0.4)]">
                      {step.id}
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-30 hidden md:block">
                  <div className="relative w-[260px] h-[260px] flex items-center justify-center group hover:scale-110 transition-transform duration-500">
                    ...
                    <motion.div
                      style={{ rotate }}
                      className="absolute inset-0 rounded-full border-2 border-[#FFFFFF]/40 border-t-white border-l-transparent drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]"
                    />
                    {/* Inner green circle */}
                    <div className="w-[90px] h-[90px] rounded-full bg-[#EAFFBF] flex items-center justify-center text-white font-bold text-3xl shadow-[0_0_40px_rgba(233,79,55,0.4)]">
                      {step.id}
                    </div>
                  </div>
                </div>
                ...
                <div className={`w-full md:w-1/2 px-6 z-10 flex flex-col items-center ${isTextOnLeft ? 'md:items-end text-center md:text-right md:pr-20 lg:pr-32' : 'justify-center md:pr-20 lg:pr-32'}`}>
                  {isTextOnLeft ? (
                    ...
                    <>
                      <div
                        className="bg-[#EAFFBF] text-white font-bold text-lg md:text-2xl py-4 md:py-5 w-max max-w-full mb-6 shadow-[0_20px_40px_rgba(0,0,0,0.4)] transform hover:-translate-y-2 hover:scale-105 transition-all duration-300 relative rounded-l-xl"
                        style={{
                      ...
                      <div className="pr-0 md:pr-2">
                        <p className="text-[#FFFFFF]/90 text-base md:text-lg leading-relaxed max-w-md drop-shadow-md">
                          {step.description}
                        </p>
                      </div>
                    </>
                    ...
                    // Image on Left
                    <div className="relative w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] group border border-[#FFFFFF]/10">
                      <Image src={step.image} alt={step.title} fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
                      <div className="absolute inset-0 bg-[#0E14CC]/20 group-hover:bg-transparent transition-colors duration-500"></div>
                    </div>
                  )}
                </div>
                ...
                <div className={`w-full md:w-1/2 px-6 z-10 flex flex-col items-center ${!isTextOnLeft ? 'md:items-start text-center md:text-left md:pl-20 lg:pl-32' : 'justify-center md:pl-20 lg:pl-32'}`}>
                  {!isTextOnLeft ? (
                    ...
                    <>
                      <div
                        className="bg-[#EAFFBF] text-white font-bold text-lg md:text-2xl py-4 md:py-5 w-max max-w-full mb-6 shadow-[0_20px_40px_rgba(0,0,0,0.4)] transform hover:-translate-y-2 hover:scale-105 transition-all duration-300 relative rounded-r-xl"
                        style={{
